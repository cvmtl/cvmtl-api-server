...
const keystore = require('./service/keystore');
...
function initDatabase() {
    ...
    if (keystore.database) {
        if (keystore.database.url) {
            databaseUrl = keystore.database.url;
        } else if (keystore.database.name) {
            databaseName = keystore.database.name;
            databaseUser = keystore.database.username;
            databasePass = keystore.database.password;
        }
    }
